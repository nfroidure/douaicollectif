  ...
  return (
    <ContentBlock>
      ...
      <Paragraph>
        ...
        votre propre agenda{" "}
        <Anchor
          href={`https://calendar.google.com/calendar/u/0/r?cid=${encodeURIComponent(`webcal://${DOMAIN_NAME}/agenda.ics`)}`}
        ...
        ,{" "}
        <Anchor
          href={`https://outlook.office.com/calendar/0/addfromweb/?url=${encodeURIComponent(`webcal://${DOMAIN_NAME}/agenda.ics`)}`}
        ...
        ,{" "}
        <Anchor
          href={`webcal://${DOMAIN_NAME}/agenda.ics`}
        ...
        ,{" "}
        <Anchor
          href={`https://${DOMAIN_NAME}/agenda.ics`}
